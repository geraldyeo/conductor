...
**Full MVP merged.** The design/documentation phase is done (8 ADRs accepted). All 10 CLI commands, the orchestrator daemon, poll-driven 16-state lifecycle, YAML config system, and IPC protocol are implemented.
